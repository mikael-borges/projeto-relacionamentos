...
@section('content')
<form class="max-w-sm mx-auto" action="{{ url('clients') }}" method="POST">
    @csrf
    <div class="mb-5">
    ...
    <div class="mb-5">
        ...
        <input type="text" name="phone" id="phone" step="0.01" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Digite o número do telefone" required />
    </div>
